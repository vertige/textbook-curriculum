...
Check out the [Documentation for String](http://www.ruby-doc.org/core-2.4.0/String.html) to see other things that you can do with `String` objects.
...
Check out the Documentation for [Integer](http://ruby-doc.org/core-2.4.0/Integer.html) and [Float](http://www.ruby-doc.org/core-2.4.0/Float.html).
